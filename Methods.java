...
public class Methods
{
     ...
     */
    public static int minimum(int f, int g){
     ...
     */
    public static boolean isOddNumber(int f){
        { // TODO
            if (f %2 == 0)
            return false;
            else 
     ...
     */
    public static boolean isEvenNumber(int g){
        {
            // TODO
            if (g  %2 != 0)
            return false;
     ...
     */
    public static boolean isConsonant(char g){
        {
            // TODO
            if (g == 'b' || g == 'c' || g== 'd' || g== 'f' || g== 'g' || g== 'h' || g=='j' || g=='k' || g=='l' || g=='m' || g== 'n' || g== 'p' || g=='q' || g=='r' || g=='s' || g== 't' || g== 'v' || g== 'w' || g== 'x' || g== 'y' || g== 'z' || g== 'B' || g=='C' || g== 'D' || g== 'F' || g=='G' || g== 'H' || g=='J' || g== 'K' || g=='L' || g== 'M' || g== 'N' || g=='P' || g=='Q' || g=='R' || g== 'S' || g== 'T' || g=='V' || g=='W' || g== 'X' || g== 'Y' || g== 'Z') 
                return true;
            else
                return false;
